    ...
    <div id="mySidenav" class="sidenav">
          ...
          <div class="books">
            ...
            <a style="color:rgb(255, 255, 255);">
                <h1>HISTORICAL </h1><br><br>
                <div class="1">
                    <!-- <label style="font-size: 30px;"> &nbsp &nbsp &nbsp &nbspGulliver’s Travel</label> -->
                    <p style="color:rgb(255, 255, 255); font-size: 20px;"><b style="font-size: 30px;"> Age Of Enlightenment </b> &nbsp  (Author - Cesare Beccaria Denis Diderot)</p><br>
                    <div style="display: flex; align-items: flex-start;">
                        <a href="books/Age of Enlightenment.pdf" download>
                            <img src="images/Age of enlightment.jpg" width="375" height="500">
                        </a>
                ...
                <div class="2">
                  <!-- <label style="font-size: 30px;"> &nbsp &nbsp &nbsp &nbspGulliver’s Travel</label> -->
                  <p style="color:rgb(255, 255, 255); font-size: 20px;"><b style="font-size: 30px;"> Titanic </b> &nbsp  (Author - Filson Young)</p><br>
                  <div style="display: flex; align-items: flex-start;">
                      <a href="books/Titanic.pdf" download>
                          <img src="images/Titanic.jpg" width="375" height="500">
                      </a>
                      <div style="margin-left: 10px;">
                          <p style="color:rgb(255, 255, 255); font-size: 20px;">
                            <br>
