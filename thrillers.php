    ...
    <div id="mySidenav" class="sidenav">
          ...
          <div class="books">
            ...
            <a style="color:rgb(255, 255, 255);">
                <h1> THRILLERS </h1><br><br>
                <div class="1">
                    <!-- <label style="font-size: 30px;"> &nbsp &nbsp &nbsp &nbspGulliver’s Travel</label> -->
                    <p style="color:rgb(255, 255, 255); font-size: 20px;"><b style="font-size: 30px;"> The House of the Seven Gables </b> &nbsp  (Author - Nathaniel Hawthorne)</p><br>
                    <div style="display: flex; align-items: flex-start;">
                        <a href="books/The-house-of-the-seven-gables.pdf" download>
                            <img src="images/The-house-of-the-seven-gables.jpg" width="375" height="500">
                        </a>
                ...
                <div class="2">
                  <!-- <label style="font-size: 30px;"> &nbsp &nbsp &nbsp &nbspGulliver’s Travel</label> -->
                  <p style="color:rgb(255, 255, 255); font-size: 20px;"><b style="font-size: 30px;"> The Count of MonteCristo </b> &nbsp  (Author - Alexandre Dumas)</p><br>
                  <div style="display: flex; align-items: flex-start;">
                      <a href="books/The Count of MonteCristo.pdf" download>
                          <img src="images/The count of monte cristo.jpg" width="375" height="500">
                      </a>
                      <div style="margin-left: 10px;">
                          <p style="color:rgb(255, 255, 255); font-size: 20px;">
                            <br>
