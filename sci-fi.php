          ...
          <div class="books">
            ...
            <a style="color:rgb(255, 255, 255);">
                ...
                <div class="1">
                    ...
                    <p style="color:rgb(255, 255, 255); font-size: 20px;"><b style="font-size: 30px;"> The Time Machine</b> &nbsp  (Author - H. G. Wells)</p><br>
                    <div style="display: flex; align-items: flex-start;">
                        <a href="books/The Time Machine.pdf" download>
                            <img src="images/The-time-machine.jpg" height="500">
                        </a>
                ...
                <div class="2">
                  <!-- <label style="font-size: 30px;"> &nbsp &nbsp &nbsp &nbspGulliver’s Travel</label> -->
                  <p style="color:rgb(255, 255, 255); font-size: 20px;"><b style="font-size: 30px;"> The Lost World </b> &nbsp  (Author -  Arthur Conan Doyle)</p><br>
                  <div style="display: flex; align-items: flex-start;">
                      <a href="books/The Lost World.pdf" download>
                          <img src="images/The lost world.jpg" width="375" height="500">
                      </a>
                      <div style="margin-left: 10px;">
                          <p style="color:rgb(255, 255, 255); font-size: 20px;">
                            <br>
