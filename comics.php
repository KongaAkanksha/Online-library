          ...
          <div class="books">
            ...
            <a style="color:rgb(255, 255, 255);">
                ...
                <div class="1">
                    ...
                    <p style="color:rgb(255, 255, 255); font-size: 20px;"><b style="font-size: 30px;"> The Battle of the Villages</b> &nbsp  (Author - Krinkelt-Rocherath)</p><br>
                    <div style="display: flex; align-items: flex-start;">
                        <a href="books/The Battle of the Villages.pdf" download>
                            <img src="images/the-battle-villages.webp" width="375" height="500">
                        </a>
                ...
                <div class="2">
                  <!-- <label style="font-size: 30px;"> &nbsp &nbsp &nbsp &nbspGulliver’s Travel</label> -->
                  <p style="color:rgb(255, 255, 255); font-size: 20px;"><b style="font-size: 30px;"> Ghosts </b> &nbsp  (Author - Raina Telgemeier)</p><br>
                  <div style="display: flex; align-items: flex-start;">
                      <a href="books/Ghosts.pdf" download>
                          <img src="images/Ghosts.jpg" width="375" height="500">
                      </a>
                      <div style="margin-left: 10px;">
                          <p style="color:rgb(255, 255, 255); font-size: 20px;">
                            <br>
