          ...
          <div class="books">
            ...
            <a style="color:rgb(255, 255, 255);">
                ...
                <div class="1">
                    ...
                    <p style="color:rgb(255, 255, 255); font-size: 20px;"><b style="font-size: 30px;"> Snow White And The Seven Dwarfs</b> &nbsp  (Author -  Jacob Grimm Wilhelm Grimm)</p><br>
                    <div style="display: flex; align-items: flex-start;">
                        <a href="books/Snow White and the Seven Dwarfs author Jacob Grimm and Wilhelm Grimm.pdf" download>
                            <img src="images/Snow White and the Seven Dwarfs.jpeg" width="375" height="500">
                        </a>
                ...
                <div class="2">
                  <!-- <label style="font-size: 30px;"> &nbsp &nbsp &nbsp &nbspGulliver’s Travel</label> -->
                  <p style="color:rgb(255, 255, 255); font-size: 20px;"><b style="font-size: 30px;"> The Princess And The Goblin </b> &nbsp  (Author - George MacDonald)</p><br>
                  <div style="display: flex; align-items: flex-start;">
                      <a href="books/The_Princess_and_the_Goblin.pdf" download>
                          <img src="images/The Princess and the Goblin.jpg" width="375" height="500">
                      </a>
                      <div style="margin-left: 10px;">
                          <p style="color:rgb(255, 255, 255); font-size: 20px;">
                            <br>
