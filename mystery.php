          ...
          <div class="books">
            ...
            <a style="color:rgb(255, 255, 255);">
                ...
                <div class="1">
                    ...
                    <p style="color:rgb(255, 255, 255); font-size: 20px;"><b style="font-size: 30px;"> The Mystery Of Edwin Drood</b> &nbsp  (Author - Charles Dickens)</p><br>
                    <div style="display: flex; align-items: flex-start;">
                        <a href="books/The Mystery of Edwin Drood.pdf" download>
                            <img src="images/The mystery of edwin drood.jpg" width="375" height="500">
                        </a>
                ...
                <div class="2">
                  <!-- <label style="font-size: 30px;"> &nbsp &nbsp &nbsp &nbspGulliver’s Travel</label> -->
                  <p style="color:rgb(255, 255, 255); font-size: 20px;"><b style="font-size: 30px;"> A Study In Scarlet </b> &nbsp  (Author - Arthur Conan Doyle)</p><br>
                  <div style="display: flex; align-items: flex-start;">
                      <a href="books/A Study In Scarlet.pdf" download>
                          <img src="images/A Study In Scarlet.jpg" width="375" height="500">
                      </a>
                      <div style="margin-left: 10px;">
                          <p style="color:rgb(255, 255, 255); font-size: 20px;">
                            <br>
