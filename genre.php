          ...
          <div class="books">
            ...
            <a style="color:rgb(255, 255, 255);">
                ...
                <div class="1">
                    ...
                    <p style="color:rgb(255, 255, 255); font-size: 20px;"><b style="font-size: 30px;"> Gulliver’s Travel</b> &nbsp  (Author - Jonathan Swift)</p><br>
                    <div style="display: flex; align-items: flex-start;">
                        <a href="books/Gulliver’s Travel author Jonathan Swift.pdf" download>
                            <img src="images/Gulliver's Travel.jpg" width="375" height="500">
                        </a>
                ...
                <div class="2">
                  <!-- <label style="font-size: 30px;"> &nbsp &nbsp &nbsp &nbspGulliver’s Travel</label> -->
                  <p style="color:rgb(255, 255, 255); font-size: 20px;"><b style="font-size: 30px;"> Robinson Crusoe </b> &nbsp  (Author - Daniel Defoe)</p><br>
                  <div style="display: flex; align-items: flex-start;">
                      <a href="books/Robinson Crusoe author Daniel Defoe.pdf" download>
                          <img src="images/Robinson-crusoe.jpg" width="375" height="500">
                      </a>
                      <div style="margin-left: 10px;">
                          <p style="color:rgb(255, 255, 255); font-size: 20px;">
                            <br>
