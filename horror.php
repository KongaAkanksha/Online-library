          ...
          <div class="books">
            ...
            <a style="color:rgb(255, 255, 255);">
                ...
                <div class="1">
                    ...
                    <p style="color:rgb(255, 255, 255); font-size: 20px;"><b style="font-size: 30px;"> The Canterville Ghost</b> &nbsp  (Author - Oscar Wilde)</p><br>
                    <div style="display: flex; align-items: flex-start;">
                        <a href="books/The-canterville-ghost.pdf" download>
                            <img src="images/the-canterville-ghost.jpg" width="375" height="500">
                        </a>
                ...
                <div class="2">
                  <!-- <label style="font-size: 30px;"> &nbsp &nbsp &nbsp &nbspGulliver’s Travel</label> -->
                  <p style="color:rgb(255, 255, 255); font-size: 20px;"><b style="font-size: 30px;"> The Castle of Otranto </b> &nbsp  (Author - Horace Walpole)</p><br>
                  <div style="display: flex; align-items: flex-start;">
                      <a href="books/The Castle of Otranto.pdf" download>
                          <img src="images/The castle of otranto.jpg" width="375" height="500">
                      </a>
                      <div style="margin-left: 10px;">
                          <p style="color:rgb(255, 255, 255); font-size: 20px;">
                            <br>
