          ...
          <div class="books">
            ...
            <a style="color:rgb(255, 255, 255);">
                ...
                <div class="1">
                    ...
                    <p style="color:rgb(255, 255, 255); font-size: 20px;"><b style="font-size: 30px;"> The Lady of the Camellias</b> &nbsp  (Author - Alexandre Dumas)</p><br>
                    <div style="display: flex; align-items: flex-start;">
                        <a href="books/The Lady of the Camellias.pdf" download>
                            <img src="images/The-lady-of-the-camellias.jpg" width="375" height="500">
                        </a>
                ...
                <div class="2">
                  <!-- <label style="font-size: 30px;"> &nbsp &nbsp &nbsp &nbspGulliver’s Travel</label> -->
                  <p style="color:rgb(255, 255, 255); font-size: 20px;"><b style="font-size: 30px;"> A Room with a View </b> &nbsp  (Author - E. M. Forster)</p><br>
                  <div style="display: flex; align-items: flex-start;">
                      <a href="books/A Room with a View.pdf" download>
                          <img src="images/A room with a view.jpg" width="375" height="500">
                      </a>
                      <div style="margin-left: 10px;">
                          <p style="color:rgb(255, 255, 255); font-size: 20px;">
                            <br>
